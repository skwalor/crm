 ...
 * 
 * This file provides all Jira-related API endpoints for the frontend.
 * 
 * Place this file in: /api/jira_api.php
 */
...
try {
    switch ($action) {
        ...
        case 'getBoardIssues':
            ...
            if (!$boardId) {
                throw new Exception('No board found for project ' . $projectKey);
            }
